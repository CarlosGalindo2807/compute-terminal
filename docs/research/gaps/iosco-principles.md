...
2026-07-09 (P7 + P8 rows point at the new proposal; queue P0 item 4 flips to
"proposal drafted, awaiting Committee review").
...
4. P7 + P8 — Proposal for the `/methodology` "published-quote benchmark" self-classification + data-input hierarchy subsection. **Proposal drafted** ([`proposals/2026-07-09-methodology-quote-benchmark-hierarchy.md`](../proposals/2026-07-09-methodology-quote-benchmark-hierarchy.md), 2026-07-09). Awaiting @CarlosGalindo2807 sign-off, then a follow-up PR edits the hard-limit `/methodology` page under the 30-day-notice procedure (effective 2026-08-08 on the fastest timeline). Closes two quality-pillar gaps in one edit.
...
- **2026-07-09** — Proposal drafted at [`proposals/2026-07-09-methodology-quote-benchmark-hierarchy.md`](../proposals/2026-07-09-methodology-quote-benchmark-hierarchy.md). P7 and P8 rows flipped from *partial* to *partial — proposal drafted*; priority-queue P0 item 4 flipped from "write the proposal" to "awaiting Committee sign-off". Under the 30-day-notice procedure the earliest effective date is 2026-08-08. No `PUBLISHED_METHODOLOGY` change; no `index_values_daily.vwap` change. (index-architect fourth run.)
