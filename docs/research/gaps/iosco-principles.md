...
2026-07-20 (P7 + P8 rows point at the self-classification proposal; queue P0
item 4 shifts from "write the proposal" to "review/approve the proposal").
...
| P7 | Data sufficiency | partial / **structurally weak** (proposal open) | All inputs anchored in a genuine arms-length cash market for GPU-hours; inputs are **firm executable list prices** (closer to BMR "committed quotes" than to indicative submissions). 24h rolling window, ≥ 6 providers when fully ramped. `invoice_observations` table exists (migration 011) as the latent transaction layer — empty today. | Inputs are executable **listings**, not observed trades. Strict P7 reading requires "anchored by observable transactions". On-demand compute has no public consolidated tape. Path mapped (see note): **Track A** — self-classify as a *published-quote benchmark* + publish data-input hierarchy on `/methodology`. **Proposal open:** [`proposals/2026-07-20-methodology-p7-p8-self-classification.md`](../proposals/2026-07-20-methodology-p7-p8-self-classification.md) (folds in P8; awaiting @CarlosGalindo2807 review). **Track B** — stand up `invoice_observations` ingest, then publish a list-price-vs-observed-effective-price reconciliation report (P1, infra, no hard-limit file). **Track C** — provider-count-scaled quorum so thin-GPU indices suppress earlier (P1, methodology-class → proposal + committee). | P0 (Track A — awaiting review) / P1 (B, C) | Proposal drafted: [`proposals/2026-07-20-methodology-p7-p8-self-classification.md`](../proposals/2026-07-20-methodology-p7-p8-self-classification.md). Next after merge: gap-matrix update per the proposal's rollout §4, then Track B ingest workstream. |
| P8 | Hierarchy of data inputs | partial (proposal open) | Hierarchy exists in code (rule → alias → fuzzy → Claude ≥ 0.95 auto → Claude 0.70–0.95 admin queue → outlier check → eligibility check → VWAP). Zero expert judgment in published-number path. | Hierarchy is implicit, not published. **Proposal open** bundles the "Hierarchy of data inputs" subsection with P7 self-classification into the same `/methodology` edit: [`proposals/2026-07-20-methodology-p7-p8-self-classification.md`](../proposals/2026-07-20-methodology-p7-p8-self-classification.md). On merge, status flips to `compliant` and this row drops from the queue. | P1 (awaiting review) | Bundled into the P7 proposal above; see [`notes/2026-05-12-listings-vs-transactions-iosco-p7.md`](../notes/2026-05-12-listings-vs-transactions-iosco-p7.md) §4–5. |
...
4. P7 + P8 — **Proposal drafted, awaiting @CarlosGalindo2807 review:** [`proposals/2026-07-20-methodology-p7-p8-self-classification.md`](../proposals/2026-07-20-methodology-p7-p8-self-classification.md). Adds "Classification: published-quote benchmark" + "Hierarchy of data inputs" subsections to `/methodology`. No formula / constant / computation change; docs-only edit to a hard-limit page. Closes two quality-pillar gaps in one edit. *Action: Committee review + approve/decline.*
...
- **2026-07-20** — P0 item 4 shifted from "write the proposal" to "review the proposal": [`proposals/2026-07-20-methodology-p7-p8-self-classification.md`](../proposals/2026-07-20-methodology-p7-p8-self-classification.md) drafted, opens Track A (self-classify + hierarchy) as a single docs-only edit to `/methodology`. Rows P7 (Track A branch) and P8 both flip to `compliant` on merge; matrix follow-up post-merge per the proposal's §Migration/rollout §4. (index-architect fourth run.)
