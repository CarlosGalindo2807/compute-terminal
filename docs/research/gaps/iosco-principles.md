...
2026-06-22 (P7 + P8 rows updated — proposal for `/methodology` self-classification +
data-input hierarchy now drafted; P0 #4 advances from research-done to
...
4. P7 + P8 — Proposal for the `/methodology` "published-quote benchmark" self-classification + data-input hierarchy subsection. *Research done ([note](../notes/2026-05-12-listings-vs-transactions-iosco-p7.md)); **proposal drafted 2026-06-22 ([proposal](../proposals/2026-06-22-published-quote-self-classification.md))**. Next step is the committee review on the proposal PR; merge starts the 30-day public-notice clock; implementation PR (page text edit) lands ≥ 30 days after. Closes two quality-pillar gaps in one edit.*
...
- **2026-06-22** — P7 and P8 rows updated: proposal drafted at [`proposals/2026-06-22-published-quote-self-classification.md`](../proposals/2026-06-22-published-quote-self-classification.md). Both rows move from `partial` (P7) / `partial` (P8) with no proposal queued, to `... proposal drafted` with the proposal path linked. Priority-queue P0 item 4 advances from "write the proposal" to "committee review on the proposal PR + 30-day notice clock on merge". No published number, no constant, and no test changes — the proposal is text-only and the implementation PR is queued for ≥ 2026-07-22. (index-architect fourth run.)
