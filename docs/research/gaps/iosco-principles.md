...
2026-06-08 (P7/P8 row + queue updated after the published-quote-classification proposal).
...
1. P3 / P5 — Conflict-of-interest disclosure + single-administrator declaration on `/methodology`. *Half-day docs work. Now the top index-architect P0 once Committee acts on item 4.*
...
4. P7 + P8 — `/methodology` "published-quote benchmark" self-classification + data-input hierarchy. *Proposal drafted 2026-06-08 ([proposal](../proposals/2026-06-08-methodology-data-input-classification.md)) — awaiting @CarlosGalindo2807 Committee review. Once approved, the follow-up PR translates §2 into the JSX edit and lands either same-day-effective (Option A) or under 30-day notice (Option B). Closes two quality-pillar gaps in one edit.*
...
- **2026-06-08** — P7 + P8 Track A proposal drafted: [`proposals/2026-06-08-methodology-data-input-classification.md`](../proposals/2026-06-08-methodology-data-input-classification.md). Awaiting @CarlosGalindo2807 Committee review. Proposal is docs-only (no constant / calculator / migration change); follow-up PR after Committee approval will edit `apps/web/app/methodology/page.tsx` (hard-limit) with two new sections (§ Data inputs, § Hierarchy of data inputs). Priority-queue P0 item 4 status moves from "write the proposal" to "Committee review". (index-architect fourth run.)
