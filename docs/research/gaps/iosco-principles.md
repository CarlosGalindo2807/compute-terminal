...
2026-06-18 (P7 + P8 rows + queue updated after the self-classification proposal was filed).
...
4. P7 + P8 — Proposal for the `/methodology` "published-quote benchmark" self-classification + data-input hierarchy subsection. **Filed 2026-06-18:** [`proposals/2026-06-18-methodology-self-classification-and-data-hierarchy.md`](../proposals/2026-06-18-methodology-self-classification-and-data-hierarchy.md). *Awaiting Committee review (@CarlosGalindo2807). On merge: P7 status moves to `partial — published-quote classification stated; invoice-observation anchor tracked as Track B`; P8 moves to `compliant`. Page-edit PR scoped to follow in a separate PR once this proposal is approved (keeps the policy step and the implementation step separable in the audit trail).*
...
7. P8 — Hierarchy-of-data-inputs subsection on `/methodology` (bundled with P0 item 4 — same proposal, same page edit, awaiting Committee review).
...
- **2026-06-18** — Track A proposal filed at [`proposals/2026-06-18-methodology-self-classification-and-data-hierarchy.md`](../proposals/2026-06-18-methodology-self-classification-and-data-hierarchy.md). P7 and P8 rows and priority-queue items 4 and 7 updated to reflect "proposal filed, awaiting @CarlosGalindo2807 Committee review". No status changes yet — those land on merge. (index-architect fourth run.)
