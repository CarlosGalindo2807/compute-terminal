...
2026-05-21 (P7 + P8 rows + queue updated — proposal now written, awaiting committee
review + implementing PR).
...
4. P7 + P8 — `/methodology` "published-quote benchmark" self-classification + data-input hierarchy subsection. *Proposal written ([proposals/2026-05-21](../proposals/2026-05-21-methodology-published-quote-self-classification.md)). **Now awaiting @CarlosGalindo2807 committee review + an implementing PR** that edits the hard-limit `/methodology` page. Closes two quality-pillar gaps in one edit. This is the blocking item for the next step.*
...
- **2026-05-21** — P7 + P8 Track-A **proposal written** ([`proposals/2026-05-21-methodology-published-quote-self-classification.md`](../proposals/2026-05-21-methodology-published-quote-self-classification.md)) — first real entry in the proposals/ directory. Self-classifies CTI as a *published-quote benchmark* + publishes the data-input hierarchy; cites IOSCO P7/P8 and EU BMR Art. 11(1)(c)/11(3)(d)/Art. 3 (verbatim text captured via search; direct PDF fetch 403 again). No change to `PUBLISHED_METHODOLOGY` — lock test passes unmodified. P7/P8 rows + P0 queue item 4 now point at the proposal, status "awaiting committee review + implementing PR". (index-architect fourth run.)
