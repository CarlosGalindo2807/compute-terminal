...
2026-05-18 (P7/P8/P14 queue items now point at the open Track-A proposal).
...
4. P7 + P8 — Proposal for the `/methodology` "published-quote benchmark" self-classification + data-input hierarchy subsection. *Proposal open: [`proposals/2026-05-18-methodology-self-classification-and-input-hierarchy.md`](../proposals/2026-05-18-methodology-self-classification-and-input-hierarchy.md) (background [note](../notes/2026-05-12-listings-vs-transactions-iosco-p7.md)). Next step is @CarlosGalindo2807 review, then a follow-up PR editing `/methodology` per the proposal's Option A. Closes two quality-pillar gaps in one edit; folds P14 disclosure into the same page block.*
...
- **2026-05-18** — Track A proposal landed: [`proposals/2026-05-18-methodology-self-classification-and-input-hierarchy.md`](../proposals/2026-05-18-methodology-self-classification-and-input-hierarchy.md). Rows P7, P8, P14 and priority-queue item P0-4 now point at it. Row statuses do **not** move yet (awaiting @CarlosGalindo2807 review and the follow-up `/methodology` PR); on merge: P7 → `partial — disclosure resolved; input-anchor pending Track B`, P8 → `compliant`, P14 → `n/a, documented on /methodology`. (index-architect fourth run.)
