...
2026-08-20 (P7 + P8 queue items now point at the concrete proposal;
`docs/research/proposals/2026-08-20-methodology-quote-classification-and-hierarchy.md`).
...
| P7 | Data sufficiency | partial / **structurally weak** | All inputs anchored in a genuine arms-length cash market for GPU-hours; inputs are **firm executable list prices** (closer to BMR "committed quotes" than to indicative submissions). 24h rolling window, ≥ 6 providers when fully ramped. `invoice_observations` table exists (migration 011) as the latent transaction layer — empty today. | Inputs are executable **listings**, not observed trades. Strict P7 reading requires "anchored by observable transactions". On-demand compute has no public consolidated tape. Path now mapped (see note): **Track A** — self-classify as a *published-quote benchmark* + publish data-input hierarchy on `/methodology`. **Proposal drafted 2026-08-20** ([`proposals/2026-08-20-methodology-quote-classification-and-hierarchy.md`](../proposals/2026-08-20-methodology-quote-classification-and-hierarchy.md)); awaits Committee review. **Track B** — stand up `invoice_observations` ingest, then publish a list-price-vs-observed-effective-price reconciliation report (P1, infra, no hard-limit file). **Track C** — provider-count-scaled quorum so thin-GPU indices suppress earlier (P1, methodology-class → proposal + committee). | P0 (Track A — in review) / P1 (B, C) | Note done: [`notes/2026-05-12-listings-vs-transactions-iosco-p7.md`](../notes/2026-05-12-listings-vs-transactions-iosco-p7.md). Proposal done: [`proposals/2026-08-20-methodology-quote-classification-and-hierarchy.md`](../proposals/2026-08-20-methodology-quote-classification-and-hierarchy.md). Next: Committee decision (Option A docs-clarification vs. Option B v1.0.1 dry-run of P12). |
| P8 | Hierarchy of data inputs | partial | Hierarchy exists in code (rule → alias → fuzzy → Claude ≥ 0.95 auto → Claude 0.70–0.95 admin queue → outlier check → eligibility check → VWAP). Zero expert judgment in published-number path. | Hierarchy is implicit, not published. | P1 | **Bundled into the P7 proposal 2026-08-20** ([`proposals/2026-08-20-methodology-quote-classification-and-hierarchy.md`](../proposals/2026-08-20-methodology-quote-classification-and-hierarchy.md) — nine-stage hierarchy as literal proposed copy). Same edit to same page; awaits Committee review. |
...
4. P7 + P8 — Proposal for the `/methodology` "published-quote benchmark" self-classification + data-input hierarchy subsection. *Research done ([note](../notes/2026-05-12-listings-vs-transactions-iosco-p7.md)); **proposal done 2026-08-20** ([`proposals/2026-08-20-methodology-quote-classification-and-hierarchy.md`](../proposals/2026-08-20-methodology-quote-classification-and-hierarchy.md)) with literal proposed page copy + Option A (docs clarification) / Option B (v1.0.1 dry-run of P12) migration paths. Awaits Committee decision. Closes two quality-pillar gaps in one edit.*
...
- **2026-08-20** — P7 Track A proposal drafted: [`proposals/2026-08-20-methodology-quote-classification-and-hierarchy.md`](../proposals/2026-08-20-methodology-quote-classification-and-hierarchy.md). Rows P7, P8 and priority-queue item P0/#4 updated to point at the proposal file; status stays `partial` until PR merges. Proposal offers Committee a choice between Option A (documentation clarification, no version bump, ships on merge) and Option B (v1.0.1 bump, 30-day notice, doubles as a dry-run of the P12 methodology-change procedure). (index-architect fourth run.)
