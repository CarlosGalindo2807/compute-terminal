...
2026-05-25 (P7/P8 rows + queue updated — Track A proposal now drafted).
...
| P14 | Submitter Code of Conduct | n/a | Inputs are scraped, not submitted. No Submitters in the LIBOR sense. | Non-applicability not yet documented as such. | — | One-line `n/a` note offered as an **optional companion edit** in the P7 Track A proposal → [`proposals/2026-05-25-published-quote-self-classification-and-data-input-hierarchy.md`](../proposals/2026-05-25-published-quote-self-classification-and-data-input-hierarchy.md). Committee's discretion to bundle. |
...
4. P7 + P8 — **Proposal drafted** ([`proposals/2026-05-25-published-quote-self-classification-and-data-input-hierarchy.md`](../proposals/2026-05-25-published-quote-self-classification-and-data-input-hierarchy.md)). *Awaiting @CarlosGalindo2807 review → then an implementation PR editing the hard-limit `/methodology` page. Closes two quality-pillar gaps in one edit; non-material (no number/version change).*
...
7. P8 — Hierarchy-of-data-inputs subsection on `/methodology` (bundled with P0 item 4 — same proposal, same page edit; **drafted**, pending review).
...
- **2026-05-25** — P7 Track A proposal **drafted**: [`proposals/2026-05-25-published-quote-self-classification-and-data-input-hierarchy.md`](../proposals/2026-05-25-published-quote-self-classification-and-data-input-hierarchy.md). Rows P7 (Track A) and P8 moved from "needs proposal" to "proposal drafted, pending @CarlosGalindo2807 review"; P14 noted as an optional companion edit in that proposal. Queue P0 item 4 / P1 item 7 updated. Proposal is a **non-material clarification** (no number/version change) — also exercises queue item 10 (dry-run of the change-control procedure). First real entry in `proposals/`. (index-architect fourth run.)
